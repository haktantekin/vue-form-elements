            ...
            <form>
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    <input type="text" id="username" class="form-control" :value="userData.username" @input="userData.username = $event.target.value">
                  </div>
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12 form-group">
                  ...
                  <textarea id="message" rows="3" class="form-control" v-model="userData.mesage"></textarea>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
              ...
              <div class="row">
                <div class="col-md-12 from-group">
                  <label>Şehir</label>
                  <select class="form-control" v-model="userData.selectedCities">
    ...
    data(){
      return{
        userData : {
          ...
          interests: [],
          gender:'',
          cities:["İstanbul", "Ankara", "İzmir", "Adana","Bursa","Konya","Trabzon"],
          selectedCities:''
        },
        switched:true,
        isSubmitted:false
